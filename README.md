...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libxi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libxi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install xorg-libxi
```
...
It is possible to list all of the versions of `xorg-libxi` available on your platform:
...
```
pixi search xorg-libxi --channel conda-forge
```
